...
Run from python_code_visualizer with "python[3] -m python_code_visualizer.recipes.get_module_names"
"""
...
from python_code_visualizer.ast_parser.parsers import assignment_parser, class_parser, function_parser, import_parser
